declare const Theme: {
    ...
    cssVariables: {
        ...
        "--sjs-article-font-xx-large-fontSize": string;
        ...
        "--sjs-article-font-x-large-fontSize": string;
        ...
        "--sjs-article-font-large-fontSize": string;
        ...
        "--sjs-article-font-medium-fontSize": string;
        ...
        "--sjs-article-font-default-fontSize": string;
