...
CONSTRAINT STAFF_ROLE_PK PRIMARY KEY (STAFF_ID),
...
ROLE_NAME		varchar(20) 	not null,
SKILL_NAME		varchar(50) 	not null,
CONSTRAINT STAFF_ROLE_SKILL_PK PRIMARY KEY (STAFF_ID, SKILL_NAME, ROLE_NAME),
...
UPD_HIRING_MANAGER_ID		int				not null,
UPD_DT						datetime		not null,
ACTIVE_STATUS				boolean			not null,
CONSTRAINT ROLE_LISTING_PK PRIMARY KEY (ROLE_ID, ROLE_LISTING_VER),
CONSTRAINT ROLE_LISTING_FK1 FOREIGN KEY (HIRING_MANAGER_ID) REFERENCES STAFF(STAFF_ID),
CONSTRAINT ROLE_LISTING_FK2 FOREIGN KEY (UPD_HIRING_MANAGER_ID) REFERENCES STAFF(STAFF_ID));
...
APPLIED_ROLE_VER			int				not null,
CONSTRAINT APPLICATION_PK PRIMARY KEY (APPLICATION_ID),
CONSTRAINT APPLICATION_FK1 FOREIGN KEY (APPLICANT_STAFF_ID) REFERENCES STAFF(STAFF_ID),
CONSTRAINT APPLICATION_FK2 FOREIGN KEY (APPLIED_ROLE_ID, APPLIED_ROLE_VER) REFERENCES ROLE_LISTING(ROLE_ID, ROLE_LISTING_VER));
...
CONSTRAINT ROLE_SKILLS_PK PRIMARY KEY (ROLE_ID, ROLE_LISTING_VER, SKILLS),
CONSTRAINT ROLE_SKILLS_FK1 FOREIGN KEY (ROLE_ID, ROLE_LISTING_VER) REFERENCES ROLE_LISTING(ROLE_ID, ROLE_LISTING_VER));
